...
class Carta
{
    ...
    function __construct(int $numero, string $nombre, string $img, string $color){
        $this->numero = $numero;
        $this->nombre = $nombre;
        $this->img = $img;
		$this->color=$color;
...
<body>
    <?php if($c != null):?>
		<div class="<?php switch ($c->getColor()) {
				case "rojo":
					echo  "centrado cajaRojo";
					break;
				case "blanco":
					echo  "centrado cajaBlanco";
					break;
				case "azul":
					echo  "centrado cajaAzul";
					break;
		}?>">
